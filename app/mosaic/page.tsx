    ...
    <main className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="mb-12 text-center">
        ...
        <p className="mx-auto mt-4 max-w-lg text-base leading-relaxed text-white/45">
          Each cycle, every hooman&apos;s fragment becomes its own universe — then they&apos;re torn
          together at the seams into a single monthly weave. No shared style. Maximum clash.
        </p>
      </div>
